...
export const DEFAULT_SHOWCASES: ShowcaseSection[] = [
  ...
  },
  {
    ...
    enabled: true,
    productIds: [
      'de821d25-d102-4a53-bc49-755ba7ed6568',
      '6b84b3af-6f11-4017-886d-3a6204f43314',
      '2cdb40d1-6b76-4a80-8b4e-628275fff3c2',
      'b3b1a631-2b83-4979-8ff7-d6b547e6aa54',
      '493eb6c8-2dc3-44ee-8e52-b042a7372a79',
      'afc7085b-7c98-4bb9-b630-99e1df3e7eb2'
    ],
  },
];
...
export const DEFAULT_BANNERS: BannerSettings = {
  ...
  spotlightTitle: 'Transparent Wireless Mouse – Tri-Mode Bluetooth 5.3 & 2.4G Rechargeable Mouse with RGB Light, 1600 DPI & Type-C',
  spotlightBrand: 'Generic',
  spotlightImage: 'https://res.cloudinary.com/dv8woouru/image/upload/v1788954463/img_6aa13171df053_0_1788948849.png',
  spotlightPrice: 1090,
  spotlightDiscountPrice: 980,
  spotlightStockText: '110 Left in Stock',
  spotlightSavingsText: 'Save ৳109 Today',
  spotlightBtnLink: '/product/transparent-wireless-mouse-tri-mode-bluetooth-5-3-2-4g-rechargeable-mouse-with-rgb-light-1600-dpi-type-c',
  showSpotlight: false,
  spotlightShowOnMobile: false,

  showFlashSale: true,
  flashSaleBannerType: 'clickable',
  flashSaleLayoutStyle: 'split',
  ...
  flashSaleSubtitle: '',
  flashSaleHours: 6,
  flashSaleTheme: 'emerald',
  flashSaleEndsAt: '',
  flashSaleBgImage: 'https://res.cloudinary.com/dv8woouru/image/upload/f_webp,q_auto/v1789533087/des_1789533086814.webp',
  flashSaleDesktopImage: 'https://res.cloudinary.com/dv8woouru/image/upload/f_webp,q_auto/v1789533087/des_1789533086814.webp',
  flashSaleMobileImage: 'https://res.cloudinary.com/dv8woouru/image/upload/f_webp,q_auto/v1789533089/82f00b2e-8de1-4027-a42c-ae2e72025240_1789533089385.webp',
  ...
  flashSaleSlides: [
    {
      ...
      link: '/products',
      title: '',
      bgImage: 'https://res.cloudinary.com/dv8woouru/image/upload/f_webp,q_auto/v1789533087/des_1789533086814.webp',
      hideText: true,
      subtitle: '',
      pageTitle: '',
      showTimer: false,
      ...
      productIds: [],
      layoutStyle: 'split',
      mobileImage: 'https://res.cloudinary.com/dv8woouru/image/upload/f_webp,q_auto/v1789533089/82f00b2e-8de1-4027-a42c-ae2e72025240_1789533089385.webp',
      desktopImage: 'https://res.cloudinary.com/dv8woouru/image/upload/f_webp,q_auto/v1789533087/des_1789533086814.webp'
    },
    {
      id: 'slide-1789367528406',
      tag: '',
      link: '/showcase/banner-slide-1789367528406',
      title: 'Rose Arabian Borka 3-Piece Set – Embroidered Koti, Inner & Matching Hijab',
      bgImage: 'https://res.cloudinary.com/dv8woouru/image/upload/v1789531077/b71aff57-1a8e-4155-8f4d-37f8a7114a46_1789531076688.webp',
      hideText: true,
      subtitle: '',
      pageTitle: 'Arabian Borka ',
      showTimer: false,
      bannerType: 'clickable',
      productIds: [
        'afc7085b-7c98-4bb9-b630-99e1df3e7eb2',
      ...
      mobileImage: 'https://res.cloudinary.com/dv8woouru/image/upload/v1789531019/df622e34-72d1-4f73-908f-2f93dfac0e7c_1789531018655.webp',
      desktopImage: 'https://res.cloudinary.com/dv8woouru/image/upload/v1789531077/b71aff57-1a8e-4155-8f4d-37f8a7114a46_1789531076688.webp'
    },
    {
      id: 'slide-1789367529041',
      tag: '',
      link: '/product/x05-handheld-turbo-fan-3000mah-rechargeable-fan-with-1-100-speed-control-digital-display-transparent-design',
      title: '',
      bgImage: 'https://res.cloudinary.com/dv8woouru/image/upload/f_webp,q_auto/v1789533030/54501e85-79e0-4779-a944-a57f3e80b859_1789533029310.webp',
      hideText: true,
      subtitle: '',
      pageTitle: '',
      productId: '2cdb40d1-6b76-4a80-8b4e-628275fff3c2',
      showTimer: false,
      bannerType: 'clickable',
      productIds: [
        '2cdb40d1-6b76-4a80-8b4e-628275fff3c2'
      ],
      mobileImage: 'https://res.cloudinary.com/dv8woouru/image/upload/f_webp,q_auto/v1789533032/deskt_1789533032236.webp',
      desktopImage: 'https://res.cloudinary.com/dv8woouru/image/upload/f_webp,q_auto/v1789533030/54501e85-79e0-4779-a944-a57f3e80b859_1789533029310.webp'
    }
  ],
