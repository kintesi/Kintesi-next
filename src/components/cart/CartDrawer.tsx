            ...
            <div className="p-5 border-t border-gray-100 bg-white space-y-4 shadow-lg">
              ...
              {appliedCoupon ? (
                ...
                <form onSubmit={handleApplyCoupon} className="flex gap-2">
                  <input
                    type="text"
                    placeholder="Enter Coupon (e.g. CARTFLY10)"
                    value={couponCode}
                    onChange={(e) => setCouponCode(e.target.value)}
                    className="flex-1 px-3.5 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-xs focus:outline-none focus:ring-2 focus:ring-emerald-500 uppercase font-medium"
                  />
                  <button
                    type="submit"
